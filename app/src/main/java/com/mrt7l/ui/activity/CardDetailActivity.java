...
import com.mrt7l.R;
import com.mrt7l.model.CardModel;
import com.mrt7l.ui.fragment.home.HomeFragmentNewest;
import com.mrt7l.utils.Constants;

import static com.mrt7l.ui.activity.BookingActivity.mTotal;
import static com.mrt7l.ui.activity.DroppingPointActivity.mDropping;
import static com.mrt7l.ui.activity.DroppingPointActivity.mPickup;
    ...
    public class GenericTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            String text = editable.toString();
                if(view.getId()== R.id.edDigit1) {
                    if (text.length() == 4)
                        mEdDigit2.requestFocus();
                } else if(view.getId()==R.id.edDigit2) {
                    if (text.length() == 4)
                        mEdDigit3.requestFocus();
                    else if (text.length() == 0)
                        mEdDigit1.requestFocus();
                } else if (view.getId() == R.id.edDigit3) {
                    if (text.length() == 4)
                        mEdDigit4.requestFocus();
                    else if (text.length() == 0)
                        mEdDigit2.requestFocus();
                } else if (view.getId() == R.id.edDigit4) {
                    if (text.length() == 0)
                        mEdDigit3.requestFocus();
                }
