...
public class PastOrdersResponse extends Observable {

    private static PastOrdersResponse instance;
    private Mrt7alBean mrt7al;

    public static PastOrdersResponse getInstance(){
        if (instance == null){
            instance = new PastOrdersResponse();
        }
        return instance;
    }
    ...
    public static class Mrt7alBean extends Observable{
        ...
        public static class DataBean extends Observable{
            ...
            public ArrayList<RateBean> getRates() {
                return rates;
            }

            public void setRates(ArrayList<RateBean> rates) {
                this.rates = rates;
            }
            ...
            public static class RateBean extends  Observable {
                private int id;
                private int user_id;
