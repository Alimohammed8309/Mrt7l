...
public class SearchTripsResponse extends Observable {
    private static SearchTripsResponse instance;

    public static SearchTripsResponse getInstance(){
        if (instance == null){
            instance = new SearchTripsResponse();
        }
        return instance;
    }
    ...
    public static class Mrt7alBean extends Observable{
        ...
        private String msg;
        private ArrayList<Mrt7alBean.DataBean> data;
        private Mrt7alBean.PaginationBean pagination;
        private ArrayList<Mrt7alBean.DaySliderBean> day_slider;
        ...
        public ArrayList<Mrt7alBean.DataBean> getData() {
            return data;
        }

        public void setData(ArrayList<Mrt7alBean.DataBean> data) {
            this.data = data;
            setChanged();
        }

        public Mrt7alBean.PaginationBean getPagination() {
            return pagination;
        }

        public void setPagination(Mrt7alBean.PaginationBean pagination) {
            this.pagination = pagination;
            setChanged();
        }

        public ArrayList<Mrt7alBean.DaySliderBean> getDay_slider() {
            return day_slider;
        }

        public void setDay_slider(ArrayList<Mrt7alBean.DaySliderBean> day_slider) {
        ...
        public static class DataBean extends Observable{
            ...
            private Mrt7alBean.DataBean.FromCityBean from_city;
            private Mrt7alBean.DataBean.ToCityBean to_city;
            ...
            private Mrt7alBean.DataBean.CompanyBean company;
            ...
            public Mrt7alBean.DataBean.FromCityBean getFrom_city() {
                return from_city;
            }

            public void setFrom_city(Mrt7alBean.DataBean.FromCityBean from_city) {
                this.from_city = from_city;
                setChanged();
            }

            public Mrt7alBean.DataBean.ToCityBean getTo_city() {
                return to_city;
            }

            public void setTo_city(Mrt7alBean.DataBean.ToCityBean to_city) {
            ...
            public Mrt7alBean.DataBean.CompanyBean getCompany() {
                return company;
            }

            public void setCompany(Mrt7alBean.DataBean.CompanyBean company) {
            ...
            public static class CompanyBean extends Observable{
                ...
                private ArrayList<Mrt7alBean.DataBean.CompanyBean.CompanyPhotosBean> company_photos;
//                private Mrt7alBean.DataBean.CompanyBean.UserBean user;
                ...
                public ArrayList<Mrt7alBean.DataBean.CompanyBean.CompanyPhotosBean> getCompany_photos() {
                    return company_photos;
                }

                public void setCompany_photos(ArrayList<Mrt7alBean.DataBean.CompanyBean.CompanyPhotosBean> company_photos) {
                    this.company_photos = company_photos;
                    setChanged();
                }

//                public Mrt7alBean.DataBean.CompanyBean.UserBean getUser() {
//                    return user;
//                }
//
//                public void setUser(Mrt7alBean.DataBean.CompanyBean.UserBean user) {
//                    this.user = user;
//                    setChanged();
//                }
