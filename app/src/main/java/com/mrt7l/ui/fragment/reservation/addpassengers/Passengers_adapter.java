...
import com.mrt7l.ui.fragment.passengers.PassengersViewModel;
...
public class Passengers_adapter extends RecyclerView.Adapter<Passengers_adapter.PlacesViewHolder> {
    ...
    private final ArrayList<AddPassengersFragment.DataBean> list;
    public Passengers_adapter(Activity activity,
                              ArrayList<AddPassengersFragment.DataBean> mlist,
    ...
    public void onBindViewHolder(@NonNull PlacesViewHolder holder, int position) {
        if (!isTrip){
            holder.rowBinding.name.setVisibility(View.GONE);
        } else {
            holder.rowBinding.name.setVisibility(View.VISIBLE);
        }
    ...
    public void showDeletePassengerDialog(String message, Activity activity,int position) {
